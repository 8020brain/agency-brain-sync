...
dispatch home, plus the Getting started path, Help/FAQ, Learn Cowork tab, Google Ads connector, and team-roster views.
...
| `public/js/*.js` | NEW | renderers: `boot.js`, `core.js`, `nav-charts.js`, `path.js`, `dashboard.js`, `connectors.js`, `faq-live.js` |
